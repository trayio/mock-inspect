...
// Taken from https://raw.githubusercontent.com/graphql/swapi-graphql/master/schema.graphql
// Additionally uses custom scalar type "Json", see bottom of schema and property 'model'
export const graphQLSchemaWithCustomTypes = `
schema {
  query: Root
}
...
type Starship implements Node {
  ...
  """
  Implements our own Scalar type 'Json' which is declared at the bottom of this schema.
  """
  model: Json
